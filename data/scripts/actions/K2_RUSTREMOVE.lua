local config = {
    ...
    [9817] = { -- Heavily Rusted Boots
        [1] = {id = 2642, chance = 6994}, -- sandals
        [2] = {id = 2643, chance = 3952}, -- leather boots
        [3] = {id = 3982, chance = 1502}, -- crocodile boots
        [4] = {id = 2641, chance = 197} -- traper boots
    },
    [9818] = { -- Rusted Boots
        [1] = {id = 2643, chance = 6994}, -- leather boots
        [2] = {id = 3982, chance = 3952}, -- crocodile boots
        [3] = {id = 2641, chance = 1502}, -- traper boots
        [4] = {id = 2195, chance = 10} -- boots of haste
    },
    [9819] = { -- Slightly Rusted Boots
        [1] = {id = 2643, chance = 6994}, -- leather boots
        [2] = {id = 3982, chance = 3952}, -- crocodile boots
        [3] = {id = 2641, chance = 1502}, -- traper boots
        [4] = {id = 2195, chance = 100} -- boots of haste
    },
}


local RUSTREMOVE = Action()

function RUSTREMOVE.onUse(player, item, fromPosition, target, toPosition, isHotkey)
